...
cmd="robot -P /root/workspace/inspur_server_automation/inspur_server_automation -d %s -r rf_report.html --reporttitle automation_testing_report --loglevel TRACE  %s " %(rf_report_path,testsuite_path)
print(cmd)
os.system(cmd)
